...
void ZorkUL::createRooms()  {
    ...
    mainland = new Room("Mainland", ":/resources/img/mainland.jpg");
            mainland->addItem(new Item("Magic Potion", ":/resources/img/magic_potion.png"));
   ...
   farm = new Room("Farm",":/resources/img/farm.jpg");
    ...
    mysWood = new Room("Mystweriou Wood",":/resources/img/mysterious_wood.jpg");
       mysWood ->addItem(new Item("Magic Potion",":/resources/img/magic_potion.png"));
    ...
    cave = new Room("cave",":/resources/img/dark_cave.jpg");
        ...
        cave ->addItem(new Item("Magic Potion",":/resources/img/magic_potion.png"));
        cave ->addItem(new Item("Magic Potion",":/resources/img/magic_potion.png"));
    ...
    volcano = new Room("Volcano",":/resources/img/volcano.jpg");
        ...
        volcano ->addItem(new Item("Magic Potion",":/resources/img/magic_potion.png"));
